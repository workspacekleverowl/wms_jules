    ...
    <div class="page-container no-break">
        ...
        <div class="header-section">
            ...
            <div class="company-info">
                ...
                @if($order->company->address_line_2)
            ...
            <tr>
                ...
                <td class="address-box" style="width:50%;">
                    ...
                    @if($order->company_name_shipping)
                        <div class="address-text">{{ $order->company_name_shipping }}</div>
                        <div class="address-text">{{ $order->company_address_shipping }}</div>
                        <div class="address-text">{{ $order->company_city_shipping }}, {{ $order->company_state_name_shipping }}</div>
                        <div class="address-text">PIN: {{ $order->company_pincode_shipping }}</div>
                        <div class="address-text">GSTIN: {{ $order->company_GST_number_shipping ?? 'N/A' }}</div>
                    @else
                        <div class="address-text">{{ $order->company_name_billing }}</div>
                        <div class="address-text">{{ $order->company_address_billing }}</div>
                        <div class="address-text">{{ $order->company_city_billing }}, {{ $order->company_state_name_billing }}</div>
