            ...
            @if (($isLastTxnPage && !$addExtraSummaryPage) || $isSummaryOnlyPage)
                ...
                <div class="summary-box">
                    ...
                    <table class="summary-table" style="width:100%;">
                         <tr>
                            @if ($showRateColumns)
                                <td><strong>Total Purchase Value:</strong> {{ number_format($data['summary']['total_sales'], 2) }}</td>
                            @else
                        ...
                        @if (($data['userSettings']['jobwork_outsourcing_mr'] ?? 'yes') !== 'no')
                        <tr>
                        ...
                        @endif
                        @if (($data['userSettings']['jobwork_outsourcing_cr'] ?? 'yes') !== 'no')
                        <tr>
                        ...
                        @endif
                        @if (($data['userSettings']['jobwork_outsourcing_bh'] ?? 'yes') !== 'no')
                        <tr>
